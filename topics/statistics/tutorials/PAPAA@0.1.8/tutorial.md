...
![All_targene_heatmap](../../images/PAPAA@0.1.8/all_targene_heatmap.png "Heatmap for mutation and gain proportions for the genes used in model across all the TCGA cancer types.")
